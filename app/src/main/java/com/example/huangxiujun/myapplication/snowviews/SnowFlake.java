package com.example.huangxiujun.myapplication.snowviews;

import android.graphics.Canvas;
import android.graphics.Paint;
import android.graphics.Point;

import com.example.huangxiujun.myapplication.RandomGenerator;
...
//        mAngle += mRandom.getRandom(-ANGLE_SEED, ANGLE_SEED) / ANGLE_DIVISOR; // 随机晃动
        ...
        mPosition.set((int) mPosition.x, (int) y);

...
//        boolean isLocalServiceWork = isServiceWork(this, "com.castiel.service.LocalCastielService");
        boolean isRemoteServiceWork = isServiceWork(this, "com.example.huangxiujun.myapplication.AppProtectService");
        if(!isRemoteServiceWork){
//            this.startService(new Intent(this,LocalCastielService.class));
            this.startService(new Intent(this,AppProtectService.class));
